...
public protocol VideoCaptureManagerDelegate: AnyObject {
    func videoCapture(_ capture: VideoCaptureManager, didCaptureVideoFrame: CVPixelBuffer?, timestamp: CMTime)
}

public class VideoCaptureManager: NSObject {
